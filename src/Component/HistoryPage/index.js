...
class HistoryPage extends Component {
  ...
  deleteDetails = id => {
    ...
    const filteredList = newHistoryList.filter(eachItem => eachItem.id !== id)
    this.setState({newHistoryList: filteredList})
  }

  render() {
    const {searchInput, newHistoryList} = this.state
    const searchResults = newHistoryList.filter(eachItem =>
